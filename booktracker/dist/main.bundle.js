...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_Operators__ = __webpack_require__("../../../../rxjs/Operators/index.js");
...
var DataService = (function () {
    ...
    DataService.prototype.getAllBooks = function () {
        ...
        return this.http.get('/api/books')
            .pipe(Object(__WEBPACK_IMPORTED_MODULE_5_rxjs_Operators__["catchError"])(function (err) { return _this.handleHttpError(err); }));
    };
    ...
    DataService.prototype.getBookById = function (id) {
        var getHeaders = new __WEBPACK_IMPORTED_MODULE_4__angular_common_http__["c" /* HttpHeaders */]({
    ...
    DataService.prototype.getOldBookById = function (id) {
        return this.http.get("/api/books/" + id)
            .pipe(Object(__WEBPACK_IMPORTED_MODULE_5_rxjs_Operators__["map"])(function (b) { return ({
            bookTitle: b.title,
            year: b.publicationYear
        }); }), Object(__WEBPACK_IMPORTED_MODULE_5_rxjs_Operators__["tap"])(function (cb) { return console.log(cb); }));
    };
